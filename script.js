...
const API = "a8c9707d787b6e6dec6f4da8cdd68525";
...
async function findLocation(name) {
  ...
  try {
    const API_URL = `https://api.openweathermap.org/data/2.5/weather?q=${name}&appid=a8c9707d787b6e6dec6f4da8cdd68525`; 
...
async function displayForeCast(lat, long) {
  const ForeCast_API = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${long}&appid=a8c9707d787b6e6dec6f4da8cdd68525`;
